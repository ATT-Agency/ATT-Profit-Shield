...
1. Who we are: ATT Agency is a creative studio operating as a registered limited liability company (LLC). Founded by Saras Totey, Ryder Thomas, and Sunny Avula. "ATT," "we," "our," and "us" refer to ATT Agency.
      ...
      <footer className="mt-auto border-t border-[#27272A] bg-[#09090B]">
        <div className="mx-auto flex max-w-screen-2xl flex-col gap-3 px-6 py-6 text-sm text-[#A1A1AA] md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
          <p className="leading-relaxed">
            An ATT AGENCY product developed by Saras Totey, Ryder Thomas, and Sunny Avula.
          </p>
